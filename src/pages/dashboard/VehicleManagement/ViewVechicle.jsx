...
//import vehicle update form component
import EditVehicle from "./EditVehicle";
//import owner details component
...
const ViewVechicle = () => {
  ...
  function getVehicleData() {
    axios.get(`/api/view-vehicle/1`).then((res) => {
      ...
      viewVehicleData_HTML_TABLE = vechiclelist.map((vehicle) => {
        ...
        return (
          <tr key={vehicle.vehicleID}>
            ...
            <td>
              <button
                className="btn btn-outline-primary bg-light text-dark btn-sm"
                onClick={() => {
            ...
            <td>
              <button className="btn btn-outline-primary bg-light text-dark btn-sm"
              onClick={() => {
                setSelectedData(vehicle);
                handleUserDataShow();
              }}>
                <i className="fas fa-user px-1"></i> Details
              </button>
            </td>
            <td>
              <button
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <RegisterVehicle handler="admin" type={1}/>
        </Modal.Body>
        <Modal.Footer>
