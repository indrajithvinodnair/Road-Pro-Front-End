...
import RegisterOfficial from "./RegisterOfficial";
...
const OfficialVehicles = () => {
  ...
  function getVehicleData() {
    axios.get(`/api/view-vehicle/3`).then((res) => {
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <EditVehicle vehicleID={selectedData["vehicleID"]} type={selectedData["vehicleAccess"]} />
        </Modal.Body>
        <Modal.Footer>
