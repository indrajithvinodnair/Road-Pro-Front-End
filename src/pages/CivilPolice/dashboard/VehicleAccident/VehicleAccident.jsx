...
// import cutom components
import ViewResult from "./ViewResult";
import ViewAccidents from "./ViewAccidents";
...
const VehicleAccident = () => {
  ...
  if (viewflag === "active") {
    VIEW_HTML = <ViewAccidents type={1} />;
  } else if (viewflag === "inactive") {
    VIEW_HTML = <ViewAccidents type={2} />;
  }
      ...
      >
        <Wrapper>
          <Card style={CardStyling}>
            ...
            />
            <Card.Body>
              <Card.Title>Register Accident Case</Card.Title>
        ...
        <Wrapper>
          ...
          <Card.Img
            ...
            />
            <Card.Body>
              <Card.Title>Manage Accident Cases</Card.Title>
              <Card.Text>
                Display logged accident cases from Road Pro Database
              </Card.Text>
              <Button
                size="lg"
                variant="info"
        ...
        {menuflag === "manage" ? (
          <>
            <Wrapper>
              <Card style={CardStyling}>
                <Card.Body>
                  <Card.Title>Vehicle with Vehicle</Card.Title>
                  <Card.Text>
                    List all Vehicle with Vehicle from Road Pro Database
                  </Card.Text>
                  <Button
                    variant="primary"
                    onClick={(e) => {
            ...
            <Wrapper>
              <Card style={CardStyling}>
                <Card.Body>
                  <Card.Title>Vehicle with Person</Card.Title>
                  <Card.Text>
                  List all Vehicle with Person from Road Pro Database
                  </Card.Text>
                  <Button
                    variant="primary"
                    onClick={(e) => {
